...
<header>
    ...
    <main class="main">
        <div class="banner">
            <img src="../img/banner5.jpg" alt="Banner Promocional">
        ...
        <div class="produtos">
                     <div class="image">
                         <img src="../img/imgprod/pretreino250.png" alt="">
                    </div>
                    <div class="text">
                        <h2>PRE-TREINO <span>250g</span></h2>
                        <p>R$105,77</p>
                        <p><del>R$115,75</del></p>
                        <br><br><br>
                        <a href="../loja/pretreino250.php"><button class="btn btn-third"> EXPERIMENTE</button></a>               
                    </div>
                </div>
                ...
                <div class="produtos">
                     <div class="image">
                         <img src="../img/imgprod/pretreino350.png" alt="">
                    </div>
                    <div class="text">
                        <h2>PRE-TREINO <span>350g</span></h2>
                        <p>R$135,66</p>
                        <p><del>R$140,99</del></p>
                        <br><br><br>
                        <a href="../loja/pretreino350.php"><button class="btn btn-third"> EXPERIMENTE</button></a>               
                    </div>
                </div>
                ...
                <div class="produtos">
                     <div class="image">
                         <img src="../img/imgprod/pretreino500.png" alt="">
                    </div>
                    <div class="text">
                        <h2>PRE-TREINO<span>500g</span></h2>
                        <p>R$180,55</p>
                        <p><del>R$210,99</del></p>
                        <br><br><br>
                        <a href="../loja/pretreino500.php"><button class="btn btn-third"> EXPERIMENTE</button></a>               
                    </div>
                </div>
