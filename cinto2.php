...
<body>
    ...
    <main>
        ...
        <div class="produtos">
            ...
            <div class="thumb-bar">
                <img src="../img/imgprod/cinto2.png" alt="Image 3" class="thumb" />

                <!-- Add more thumbnail images as needed -->
            </div>
            <div class="full-img">
                <img class="displayed-img" src="../img/imgprod/cinto2.png" alt="Image 3" />
            ...
            <section class="especialidades">
                <div class="interface">
                    <div class="flex">
                        <div class="produtos-box">
                            <h2>CINTO DE TREINAMENTO PREMIUM</h2>
                            <p>R$120,90</p>
