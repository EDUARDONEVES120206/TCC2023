<!DOCTYPE html>
 <!-- Pesquisa dos Usuarios --> <!-- Pesquisa dos Usuarios --> <!-- Pesquisa dos Usuarios --> <!-- Pesquisa dos Usuarios --> <!-- Pesquisa dos Usuarios -->
<html>
...
<div class="lista-centralizadaPesquisa">
    ...
    if (isset($_GET['pesquisa'])) {
        ...
        $sql = "SELECT * FROM tbusuario WHERE login = '$pesquisa'";
        $resultado = $mysql->con->query($sql);

        // Verificar se a consulta foi bem-sucedida
        if ($resultado) {
            // Loop para exibir informações do usuário
            echo "<h3>Usuario <img src='../img/logobranco.png' alt='Logo' class='logo'>  </h3> ";
            ...
            while ($usuario = $resultado->fetch_assoc()) {
                ...
                echo "<td><b>" . $usuario['cpf'] . "</b></td>";
                echo "<td><b>" . $usuario['email'] . "</b></td>";
                echo "<td><b>" . $usuario['plano'] . "</b></td>";
                echo "<td><b>" . $usuario['nivel'] . "</b></td>";
                $cpf = base64_encode($usuario['cpf']);
                echo "<td><a href='adm_alterar_parceiro.php?cpf_cnpj=" . $usuario['cpf'] . "'>Alterar</td>";
                echo "<td><a href='adm_apagar_parceiro.php?cpf_cnpj=" . $usuario['cpf'] . "'>Deletar</td>";
