...
<header>
    ...
    <main>
        ...
        <div class="produtos">
            ...
            <div class="thumb-bar">
                <img src="../img/imgprod/camisa2.png" alt="Image 3" class="thumb" />
                <div class="imgtab"><img src="../img/imgprod/tamanhotab.png" alt="Image 4" class="thumb" /></div>

                <!-- Add more thumbnail images as needed -->
            </div>
            <div class="full-img">
                <img class="displayed-img" src="../img/imgprod/camisa2.png" alt="Image 3" />
            ...
            <section class="especialidades">
                <div class="interface">
                    <div class="flex">
                        <div class="produtos-box">
                        <h2>CAMISA BPOLONG</h2>
                        <p>R$115,55</p>
                        <p><del>R$130,99</del></p>
